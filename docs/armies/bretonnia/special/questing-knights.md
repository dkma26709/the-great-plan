...
>
> **Points 40 per model** — +5 over KotR's 35. Premium covers: **+1 S** (~2 pts — major wounding upgrade), **+1 I** (~1 pt — better strike order), **Stubborn** from Questing Vow (~4 pts — substantial morale layer), **consistent-damage great weapon** profile vs KotR's charge-spike lance (rough parity, ~+1 net). Offsetting: **3+ save vs 2+ save** (-3 pts — meaningful durability loss against AP -1 and AP 0 attacks). Net premium: +5. Vs Imperial Knight (24 pts, M 8 barded, no Stubborn, no Blessing): +16 covers all three Bretonnian layers plus the Questing-tier stat / vow upgrades.
>
> **Compare:**
