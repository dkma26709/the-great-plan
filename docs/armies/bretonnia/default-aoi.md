...
> The classic Bretonnian army — a chivalric host led by a sworn Lord, anchored by Lance-Formation Knights of the Realm and reinforced by Errant cousins, Questing veterans, and Pegasus-borne aerial hunters. Damsels and Prophetesses of the Lady channel forest-magic; Men-at-Arms and Longbowmen anchor objectives the knights have ridden past; the Field Trebuchet shells what the knights can't reach. Almost every model is a horseman; the army's heart is the cavalry charge, the Lance Formation lance-tip biting deepest at impact, the Lady's hand turning aside the worst the enemy offers in return.

**Composition Table** *(default constraints per §9.1)*:

| Category | Constraint |
|---|---|
| Lords | Maximum 25% of army points |
| Heroes | Maximum 25% of army points |
| Core | Minimum 25% of army points |
| Special | Maximum 50% of army points |
| Rare | Maximum 25% of army points |
...
**Army-wide rules:** None. (Themed AoIs may add — e.g., a *Crusaders of the Twin-Tailed Comet* AoI might add Hatred (Chaos), an *Errantry of the Lady* AoI might shift Knights Errant to Special and force min 50% Knights units, a *Quenelles* AoI might unlock Questing Knights as Core.)

**Mandatory picks:** None.
