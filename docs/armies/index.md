...
The factions drafted so far. Each army has its own section with faction-specific identity rules, unit profiles, and (where applicable) a faction-exclusive magic lore.

## Drafted

- **[Seraphon (Lizardmen)](seraphon/index.md)** — proof-of-concept army; the most heavily iterated faction
...
|---------|---------------------|------------------|------------|
| Seraphon | Predatory Fighter cascade + monster impact hits | Natural Armour + Cold-Blooded recovery | Apex (Slann all 12 lores) |
