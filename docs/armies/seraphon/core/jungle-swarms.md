...
- **Unit type:** Swarm
- **Unit size:** 2-6 bases
- **No armour save** — raw wound count is the defence, not hide or shield
- **Equipment:** none (natural fangs and venom)
...
- **Special rules:**
  ...
  - **Unstable** (see §8)
  - **Smothering Mass** — while an enemy unit is in base contact with this swarm, the enemy **cannot voluntarily Fall Back, Flee, or Disengage**. (Involuntary movement from losing combat resolution still applies.) The swarm crawls up legs and into mouths — escape is a clearance operation, not a movement action.
