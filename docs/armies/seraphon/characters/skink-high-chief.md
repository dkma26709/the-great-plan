...
> The apex Skink battle-commander. Where the Skink Chief coordinates a scout group, the High Chief coordinates a battle line — dozens of Skink Skirmishers, a cohort block or two, a warbeast pair. Ancient, scar-scaled, notably larger than an ordinary Skink from years of predator's wages. Traditionally rides a Stegadon into battle: the senior Skink on the senior war-mount. Second only to the Skink Priests in the Skink chain of command, and in functional terms the Skink-caste's representative at the general's council when a Slann is entranced.

**Skink High Chief:**

| M | WS | BS | S | T | W | I | Ld | LiS | US |
|---|----|----|---|---|---|---|----|-----|----|
| 8 | 5  | 6  | 4 | 4 | 5 | 7 | 10 | 1   | 2  |
...
- **Natural Armour:** 6+ (veteran Skink scales; + shield → 5+)
- **Ward Save:** — (none baseline)
- **Equipment (default):** Hand weapon + Blowpipe + shield
- **Equipment options:**
...
- **Hand weapon** *(default melee, 1H)* — 1" | **A 3** | S 4 | AP 0 | D 1 (bump from Chief A 2 to reflect Lord tier)
- **Celestite Spear** *(option, 1H)* — 2" | A 3 | S 4 | AP -1 | D 1
- **Celestite Blade** *(option, 1H)* — 1" | A 3 | S+1 (= S 5) | AP -1 | D 1
- **Celestite Halberd** *(option, 2H)* — 2" | A 3 | S+1 | AP -1 | D 1 — no shield permitted
- **Additional Hand Weapon** — adds +1 A to the hand weapon profile (A 4 total, no other effect)
- **Blowpipe** *(default ranged)* — 18" range | S 3 | AP 0 | D 1 | **Multiple Shots (2)** | Quick to Fire | Poisoned Attacks
- **Moonstone Javelin** *(option)* — 8" range | S 4 | AP -1 | D 1 | Quick to Fire | Poisoned Attacks baseline
- **Skink Sling** *(option)* — 18" range | S 4 | AP -1 | D 1
- **Shortbow** *(option)* — 18" range | S 3 | AP 0 | D 1

> **Lore notes:** WS 5 (above Chief's WS 4) — veteran combat skill, no longer rear-line only. **BS 6** matches the Chameleon Stalker (the apex shot in the roster); reflects lore "the best-shot Skink in the army" scaled to Lord tier. S 4 / T 4 stepped above Chief for aged frame. W 5 Lord-tier Skink durability (5x Cohort W 1, 1.67x Chief W 3). I 7 / Ld 10 match Lord-tier calibration (Ld 10 = Saurus Oldblood parity, ruleset cap). **Strategist of the Skink-caste** is the Lord upgrade of Target Designation: double range, stacking +1 hit AND +1 wound buff, plus Ld 8 aura to nearby Skinks (Skink Cohort Ld 6 → 8 within 12" of High Chief). Scout inherited unchanged. Stegadon mount option is unique to this character — matches lore (the Skink High Chief is the canonical Stegadon-rider among character types; Skink Chiefs without "High" don't typically mount a full Stegadon). Points 170 matches Scar-Veteran tier — the Skink-caste Lord is priced similarly to the Saurian-caste Hero, reflecting that Skink Lord mechanically buffs the army more than it fights the enemy.
