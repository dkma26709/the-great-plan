...
> **Lore notes:** The Lord's deputy and personal champion — a knight risen to Hero-tier rank through battlefield merit, often the Lord's son or a household champion. The Paladin rides at the Lord's right hand and carries the Battle Standard in many duchies. Where the Lord is the army's spirit, the Paladin is its sword-arm — the knight expected to ride out and slay the enemy's champion, accept challenges of single combat. **Champion of the Realm** is the always-active identity: reroll failed to-Hit against any enemy Character in melee, the chivalric-duel tradition rendered mechanically. Modest per-round value, but it fires *every* duel — a *consistent* duellist, not a *once-per-game* champion. Same Vow upgrade ladder as the Bretonnian Lord (Crusader's / Questing / Grail) at half the Lord's costs; no Royal Hippogryph option (flying monster mounts are Lord-tier only).
