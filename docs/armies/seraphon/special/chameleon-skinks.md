...
- **Equipment options:**
  - **Skink Sling + shield** (free swap — replaces Dartpipe with Sling, adds shield). Trades 18" poisoned precision for 12" unpoisoned volume and a 5+ combined save.
- **Command options:**
