...
> The forge-lore. Where Fire destroys and Light protects, Metal **masters a substance** — and that substance is everywhere on the battlefield. Its specialities: armour manipulation (corroding enemy plate, fortifying friendly plate), weapon enchantment (friendly AP and damage buffs), precision damage (narrow, high-per-hit, often armour-focused), and alchemical transmutation (permanent armour and weapon debuffs). Flavour register: bronze and silver, furnace glow, the smell of hot iron. Metal is not protective-light like Light, nor burning-destruction like Fire — it is *mastery over metal*, and every sword, breastplate, and buckle is its domain.

**Lore Attribute — Galvanic Resonance:** this wizard's spells gain **+1 to casting rolls** when targeting units with **natural armour save of 4+ or better**. A static precondition — the more metal the target wears, the more receptive they are to Metal magic. Rewards casting into the teeth of heavy armour exactly where the lore is designed to bite.
...
Natural Armour is not counted. The unit's own plate turns against it — each step becomes leaden. Devastating against heavy cavalry (knights in 2+ go from M7 to M3); useless against skirmishers.
...
Models with no worn armour cannot be wounded (per Armour-Seeking). The 4+ to-hit layer keeps even the strongest cast from wiping strong units outright — half the unit is filtered before the wound rolls cascade. A 10-knight regiment in 2+ armour averages ~4 dead; a 20-unarmoured-barbarian warband loses zero. The signature Metal capstone: armour turns to gold while flesh stands untouched.
...
**Transmutation of Lead** *(Summoning)*
