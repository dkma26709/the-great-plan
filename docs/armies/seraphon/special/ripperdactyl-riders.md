...
- **Special rules:**
  ...
  - **Toad Rage** — at the start of the battle, after deployment and before turn 1 begins, the controlling player places a **Blot Toad Marker** on one enemy unit of their choice. The marker remains for the rest of the battle. Whenever this unit makes attacks against the marked unit:
    ...
    - The Ripperdactyl mount may **reroll failed wound rolls**
    The Blot Toad is a Lustrian amphibian whose glandular secretion is rubbed on the Ripperdactyl's beak and eye-ridges before battle — the mount fixates on whatever the marker was placed on and hunts that quarry above all else.
