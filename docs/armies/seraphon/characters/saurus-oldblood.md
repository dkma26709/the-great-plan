...
- **Natural Armour:** **2+** (Skink-attendant-applied bronze armour-plates atop thick Oldblood scales — matches Bastiladon for sheer save quality; the Oldblood is a walking fortress)
...
- **Equipment options** (pick one melee):
  ...
  - Magic items up to 100 pts (including Blessed Spawnings — see deferred §9 mechanic)
- **Mount options:**
