...
> **Lore notes:** The army's commander — duke, senior noble, or veteran knight elevated to the highest chivalric station. **Combat-lord identity:** the Bretonnian Lord leads from the front rank, rides at the head of the charge, and takes blows from the enemy front line. The Vow upgrade ladder (Crusader's, Questing, Grail) lets the player invest in stronger faction-internal layers as a list-build choice. Grail Vow is the apex — improved Blessing, Stubborn, Immune to Psychology; Frenzy explicitly *not* granted (the Grail-touched knight is serene under divine protection, not berserk; he has stood before the Lady and returned with calm certainty, not rage). **Inspiring Charge** is the unit-internal identity: when the Lord charges, friendly Bretonnia units within 18" of his post-charge position may reroll failed charge distance for the rest of the Movement phase — the chivalric "lead from the front" lore made tactical. Mounts span the chivalric ladder: Warhorse (everyday duke), Pegasus (airborne tradition), Royal Pegasus (apex flying mount), Royal Hippogryph (legendary monster-mount of the realm's greatest knights — Lord-tier only).
