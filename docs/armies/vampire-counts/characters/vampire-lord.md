...
> **Lore notes:** Centuries-old, mind-bending, warp-fast, sword-master, necromancer — the apex of a vampire bloodline. Combines Lord-tier combat killer and Lord-tier wizard in one model: WS 7 swordwork plus Lvl 2-4 Wizard with three intrinsic lores (Death + Necromancy + Shadow). **Vampiric Hunger** is the universal vampire trait — Bite wounds regenerate 1 W (capped 1 W/turn). The **Bite weapon** is the iconic flair: once per melee round, tied to the model's nature rather than equipment (applies regardless of weapon swap). Doesn't trigger Red Fury, avoiding cascading-loop concerns. **Bloodline Powers** customise the vampire's flavour and combat style — Red Fury (cascade-strike Carstein), Quickblood (always-first Strigoi), Forbidden Lore (knowledge-hoarder Lahmian), and others. **Necromantic Anchor** stabilises the necromantic web: friendly Undead within 12" Crumble for 1 less wound at end of Combat phase — the Vampire Lord's presence reinforces the binding magic, slowing dissolution under sustained pressure.
