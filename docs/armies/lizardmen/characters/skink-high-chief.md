...
- **Hand weapon** *(default melee, 1H)* — 1" | **A 3** | S 4 | AP 0 | D 1 (bump from Chief A 2 to reflect Lord tier) `[1H Blade]`
- **Celestite Spear** *(option, 1H)* — 2" | A 3 | S 4 | AP -1 | D 1 `[1H Reach]`
- **Celestite Blade** *(option, 1H)* — 1" | A 3 | S+1 (= S 5) | AP -1 | D 1 `[1H Blade]`
- **Celestite Halberd** *(option, 2H)* — 2" | A 3 | S+1 | AP -1 | D 1 — no shield permitted `[1H Reach]`
