...
- **Keywords:** Vampire Counts, Undead, Wight, Infantry, Special
- **Unit type:** Infantry
- **Unit size:** 10-20
- **Natural Armour:** —
- **Worn armour (default):** Medium armour
- **Combined save (default):** **4+** (medium armour 5+ → shield 4+)
- **Worn armour options:**
  - Heavy armour (+2 pt/model — replaces medium armour) → 3+ save
- **Equipment (default):** Wight Blade (hand weapon) + shield
